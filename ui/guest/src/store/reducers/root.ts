...
// region dragover
// const dragover = (state, action) => {};
// endregion

// region dragleave
const dragleave = (state) => {
...
const reducerFunctions: {
  [K in GuestActionTypes]: (
    state: GuestState,
    action: StandardAction<unknown, GuestActionTypes>
  ) => GuestState;
} = {
  computed_dragend,
  computed_dragover,
