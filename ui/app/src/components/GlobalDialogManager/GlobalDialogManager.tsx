...
const RejectDialog = lazy(() => import('../RejectDialog/RejectDialog'));
const EditSiteDialog = lazy(() => import('../EditSiteDialog/EditSiteDialog'));
const ConfirmDialog = lazy(() => import('../ConfirmDialog/ConfirmDialog'));
const ErrorDialog = lazy(() => import('../ErrorDialog/ErrorDialog'));
const NewContentDialog = lazy(() => import('../NewContentDialog'));
const ChangeContentTypeDialog = lazy(() => import('../ChangeContentTypeDialog'));
const HistoryDialog = lazy(() => import('../HistoryDialog/HistoryDialog'));
...
const CopyItemsDialog = lazy(() => import('../CopyDialog/CopyDialog'));
const CreateFileDialog = lazy(() => import('../CreateFileDialog'));
const BulkUploadDialog = lazy(() => import('../UploadDialog/UploadDialog'));
...
const ItemMenu = lazy(() => import('../ItemActionsMenu/ItemActionsMenu'));
const ItemMegaMenu = lazy(() => import('../ItemMegaMenu/ItemMegaMenu'));
const AuthMonitor = lazy(() => import('../AuthMonitor/AuthMonitor'));
const PublishingStatusDialog = lazy(() => import('../PublishingStatusDialog'));
const UIBlocker = lazy(() => import('../UIBlocker/UIBlocker'));
const PathSelectionDialog = lazy(() => import('../PathSelectionDialog'));
const UnlockPublisherDialog = lazy(() => import('../UnlockPublisherDialog'));
const WidgetDialog = lazy(() => import('../WidgetDialog/WidgetDialog'));
