...
import { getEditorMode } from '../../../utils/content';
...
const createAddMenuOptions = ({
	...
	// TODO: note - apply in image/video
	refs: RefObject<{
...
function NodeSelector(props: NodeSelectorProps) {
	...
	const handleOpenItem = (event: { stopPropagation(): void }, index: number, edit: boolean = false) => {
		...
		// TODO: need to find a better way to determine if item is a file
		if (item.component || (item.include && !item.fileSize_smv)) {
