...
export interface TypeConfigurationProps extends TypeBuilderControl {
	value: string;
}

/**
 * Allows the edition of the 'config.xml' file for a content type.
 */
export function TypeConfiguration(props: TypeConfigurationProps) {
	...
	const onEditConfiguration = () => {
		dispatch(
			showCodeEditorDialog({
				path: `${basePath}${contentTypeId}/${fileName}`,
				mode: 'xml'
			})
		);
	};
