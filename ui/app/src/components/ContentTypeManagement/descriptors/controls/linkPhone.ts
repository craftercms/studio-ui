...
export const inputPhoneDescriptor: DescriptorContentType = {
	id: 'input-phone',
	name: defineMessage({ defaultMessage: 'Input - Phone' }),
	description: defineMessage({ defaultMessage: 'Input field for phone number with validation.' }),
	sections: [
...
export default inputPhoneDescriptor;
