...
export const inputEmailDescriptor: DescriptorContentType = {
	id: 'input-email',
	name: defineMessage({ defaultMessage: 'Input - Email' }),
	description: defineMessage({ defaultMessage: 'Input field for email addresses with validation.' }),
	sections: [
...
export default inputEmailDescriptor;
