...
import { RecycleBinConflict, RecycleBinDetailedPackage } from '../../models/RecycleBin';

interface RecycleBinRestoreDialogBase {
  restorePackage: RecycleBinDetailedPackage;
  onRestore(conflicts: RecycleBinConflict[]): void;
}
