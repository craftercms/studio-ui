...
export const dragAndDropMessages = defineMessages({
  ...
  pathNotFound: {
    ...
    defaultMessage:
      'Path is missing. Drag and drop will be impaired. More info at craftercms.com/docs/3.1/system-administrators/upgrade/index.html.'
  },
  objectIdNotFound: {
    id: 'dragAndDropMessages.objectIdNotFound',
    defaultMessage:
      'Object id is missing. Drag and drop will be impaired. More info at craftercms.com/docs/3.1/system-administrators/upgrade/index.html.'
  }
});
