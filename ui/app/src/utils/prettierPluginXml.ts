...
// @see https://github.com/prettier/plugin-xml/issues/28
// @see https://github.com/prettier/plugin-xml/pull/29
// @see https://github.com/prettier/plugin-xml/pull/55
...
const print = (path, opts, print) => nodes[path.getValue().name](path, opts, print);
