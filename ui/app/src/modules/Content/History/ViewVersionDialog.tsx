...
function LegacyVersionDialog(props: VersionViewProps) {
  ...
  return (
    <iframe
      ...
      src={`http://localhost:8080/studio/diff?site=${version.site}&path=${encodeURI(version.path)}&version=${version.versionNumber}&versionTO=${version.versionNumber}&mode=iframe&ui=next`}
    />
  );
}
