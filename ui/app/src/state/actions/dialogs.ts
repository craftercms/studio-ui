...
export const showLaunchpad = /*#__PURE__*/ createAction<Partial<LaunchpadStateProps>>('SHOW_GLOBAL_NAV');

export const closeLaunchpad = /*#__PURE__*/ createAction('CLOSE_GLOBAL_NAV');
