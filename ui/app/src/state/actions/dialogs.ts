...
export const showViewVersionDialog = createAction<Partial<ViewVersionDialogStateProps>>(
...
export const closeCompareVersionsDialog = createAction<StandardAction>(
  'CLOSE_COMPARE_VERSIONS_DIALOG'
);
...
// region Publish
export const showPublishDialog = createAction<Partial<PublishDialogStateProps>>(
  'SHOW_PUBLISH_DIALOG'
);
...
export const showWorkflowCancellationDialog = createAction<
  Partial<WorkflowCancellationDialogStateProps>
>('SHOW_WORKFLOW_CANCELLATION_DIALOG');
export const closeWorkflowCancellationDialog = createAction<StandardAction>(
...
export const showCodeEditorDialog = createAction<Partial<LegacyCodeEditorDialogStateProps>>(
...
export const showCreateFolderDialog = createAction<Partial<CreateFolderStateProps>>(
...
export const showCreateFileDialog = createAction<Partial<CreateFileStateProps>>(
...
// region Edit Site
export const showEditSiteDialog = createAction<Partial<EditSiteDialogStateProps>>(
