...
export const EMBEDDED_LEGACY_FORM_PREVIEW_REFRESH = 'EMBEDDED_LEGACY_FORM_PREVIEW_REFRESH';
export const EMBEDDED_LEGACY_FORM_MINIMIZE = 'EMBEDDED_LEGACY_FORM_MINIMIZE';
