...
export const showDeleteItemSuccessNotification = /*#__PURE__*/ createAction<StandardAction>(
  'SHOW_DELETE_ITEM_SUCCESS_NOTIFICATION'
);

export const showPublishItemSuccessNotification = /*#__PURE__*/ createAction<StandardAction>(
...
export const showCopyItemSuccessNotification = /*#__PURE__*/ createAction<StandardAction>(
