...
class AddFiles extends Component {
	...
	renderHiddenCameraInput = (type, nativeCameraFacingMode, refCallback) => {
		...
		return (
			<input
				...
				name={`camera-${type}`}
				onChange={this.onFileInputChange}
				capture={nativeCameraFacingMode === '' ? 'environment' : nativeCameraFacingMode}
				accept={accept}
				ref={refCallback}
			/>
		);
	...
	renderMyDeviceAcquirer = () => {
		return (
			<div className="uppy-DashboardTab" role="presentation" data-uppy-acquirer-id="MyDevice">
				<button
					type="button"
	...
	renderPhotoCamera = () => {
		return (
			<div className="uppy-DashboardTab" role="presentation" data-uppy-acquirer-id="MobilePhotoCamera">
				<button
					type="button"
					className="uppy-u-reset uppy-c-btn uppy-DashboardTab-btn"
					role="tab"
	...
	renderVideoCamera = () => {
		return (
			<div className="uppy-DashboardTab" role="presentation" data-uppy-acquirer-id="MobileVideoCamera">
				<button
					type="button"
					className="uppy-u-reset uppy-c-btn uppy-DashboardTab-btn"
					role="tab"
	...
	renderAcquirer = (acquirer) => {
		return (
			<div className="uppy-DashboardTab" role="presentation" data-uppy-acquirer-id={acquirer.id}>
				<button
					type="button"
					className="uppy-u-reset uppy-c-btn uppy-DashboardTab-btn"
					role="tab"
