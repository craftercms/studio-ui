...
function UploadNewlyAddedFiles(props) {
	...
	return (
		<div className="uppy-StatusBar-statusSecondary">
			<div className="uppy-StatusBar-statusSecondaryHint">{i18n('xMoreFilesAdded', { smart_count: newFiles })}</div>
			<button
				type="button"
				className={uploadBtnClassNames}
				aria-label={i18n('uploadXFiles', { smart_count: newFiles })}
...
function ProgressBarUploading(props) {
	...
	function renderProgressDetails() {
		if (!isAllPaused && !showUploadNewlyAddedFiles && !hideProgressDetails) {
			...
			return <FileUploadCount i18n={i18n} complete={complete} numUploads={numUploads} />;
		}
		return null;
	}
