...
const { STATE_ERROR, STATE_WAITING, STATE_PREPROCESSING, STATE_UPLOADING, STATE_POSTPROCESSING, STATE_COMPLETE } =
	statusBarStates;
...
export default function StatusBarUI({
	...
	const progressBarStateEl = (() => {
		switch (uploadState) {
			...
			case STATE_ERROR:
				return <ProgressBarError error={error} i18n={i18n} numUploads={numUploads} complete={complete} />;
			case STATE_UPLOADING:
				return (
					<ProgressBarUploading
						i18n={i18n}
