	...
	return (
		...
		>
			<div className="uppy-DashboardContent-bar">
				...
				<button className="uppy-DashboardContent-back" type="button" onClick={handleCancel}>
					{props.i18n('cancel')}
				</button>
				<button className="uppy-DashboardContent-save" type="button" onClick={props.saveFileEditor}>
					{props.i18n('save')}
				</button>
			</div>
