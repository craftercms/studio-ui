    ...
    YAHOO.extend(Panel, Overlay, {
        ...
        */
        ...
        _onElementFocus : function(e){
            var authDialog = document.getElementById('auth-monitor-dialog');
            var target = Event.getTarget(e);

            if (target !== this.element && (!authDialog && !Dom.isAncestor(authDialog, target)) && !Dom.isAncestor(this.element, target) && _currentModal == this) {
                try {
