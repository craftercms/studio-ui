    ...
    cfe.engine = {
        ...
        if (0 === formDef.datasources.length) {
          ...
          for (var i = 0, l = formDef.datasources.length; i < l; i++) {
            ...
            script =
              ...
              '/static-assets/components/cstudio-forms/data-sources/' +
              datasourceDef.type +
              '.js';
              ...
              return function (script, textStatus) {
                try {
                  if ('' === script) {
                    ...
                    var moduleClass =
                      CStudioAuthoring.Module.loadedModules['cstudio-forms-controls-' + datasourceDef.type];
      ...
      _renderField: function (
        ...
        CStudioAuthoring.Module.requireModule(
          ...
          { config: { field: field, repeatField: repeatField, repeatIndex: repeatIndex } },
          cb
        );
      },
      ...
      _renderIceLayout: function (form) {
        ...
        html +=
          "<div class='cstudio-form-controls-container'>" + // command bar
          '</div>';
        html += '</div>';
