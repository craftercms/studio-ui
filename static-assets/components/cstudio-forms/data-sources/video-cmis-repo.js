...
CStudioForms.Datasources.VideoCMISRepo= CStudioForms.Datasources.VideoCMISRepo ||
        ...
        CStudioAuthoring.Operations.openCMISBrowse(_self.repoId, _self.repoPath, _self.studioPath, _self.allowedOperations, "select", true, {
            success: function(searchId, selectedTOs) {
                ...
                var cb = function(repositories){
                    ...
                    if(item.clone){        //clone
                        relativeUrl = _self.studioPath.endsWith("/") ? _self.studioPath+fileName : _self.studioPath+ "/" +fileName;
