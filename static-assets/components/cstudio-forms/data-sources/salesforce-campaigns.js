...
CStudioForms.Datasources.SalesforceCampaigns =
  CStudioForms.Datasources.SalesforceCampaigns ||
  function(id, form, properties, constraints) {
    ...
    YAHOO.util.Connect.asyncRequest('GET', '/api/1/services/salesforce/active-campaigns.json', cb);
...
CStudioAuthoring.Module.moduleLoaded(
  'cstudio-forms-controls-salesforce-campaigns',
  CStudioForms.Datasources.SalesforceCampaigns
);
