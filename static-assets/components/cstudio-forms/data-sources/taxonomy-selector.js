...
CStudioForms.Datasources.TaxonomySelector = CStudioForms.Datasources.TaxonomySelector ||
...
YAHOO.extend(CStudioForms.Datasources.TaxonomySelector, CStudioForms.CStudioFormDatasource, {

  getLabel: function () {
    return CrafterCMSNext.i18n.intl.formatMessage(this.messages.taxonomySelectorMessages.label);
  },
