...
(function () {
  ...
  YAHOO.extend(CStudioForms.Controls.LocaleSelector, CStudioForms.CStudioFormField, {
    ...
    _onChange: function _onChange(evt, obj) {
      this.validate(obj);
      obj.form.updateModel(obj.id, obj.getValue());
    },
    _onChangeVal: function _onChangeVal(evt, obj) {
      obj.edited = true;
    ...
    render: function render(config, containerEl) {
      ...
      CrafterCMSNext.services.translation.getSupportedLocales(CStudioAuthoringContext.site).subscribe(function (_ref) {
