CStudioForms.Controls.LinkedInput = CStudioForms.Controls.LinkedInput ||  
...
YAHOO.extend(CStudioForms.Controls.LinkedInput, CStudioForms.CStudioFormField, {

    getLabel: function() {
        return CMgs.format(langBundle, "linkedInput");
    },
	...
	render: function(config, containerEl) {
		...
		YAHOO.util.Dom.addClass(controlWidgetContainerEl, 'cstudio-form-control-linked-input-container');
...
CStudioAuthoring.Module.moduleLoaded("cstudio-forms-controls-linked-input", CStudioForms.Controls.LinkedInput);