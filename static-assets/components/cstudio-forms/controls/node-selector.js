...
CStudioForms.Controls.NodeSelector = function(
  id,
  form,
  owner,
  properties,
  ...
  CStudioForms.CStudioFormField,
  {
    ...
    render: function(config, containerEl) {
      ...
      for (var i = 0; i < config.constraints.length; i++) {
        ...
        if (
          constraint.name == 'allowDuplicates' &&
      ...
      for (var i = 0; i < config.properties.length; i++) {
        ...
        if (prop.name == 'itemManager') {
          this.datasourceName = Array.isArray(prop.value)
            ? prop.value[0]
            : prop.value;
      ...
      YAHOO.util.Dom.addClass(
        ...
        'cstudio-form-control-node-selector-container'
      );
      ...
      YAHOO.util.Dom.addClass(
        validEl,
        'cstudio-form-control-validation fa fa-check'
      );
      ...
      YAHOO.util.Dom.addClass(
        nodeControlboxEl,
        'cstudio-form-control-node-selector-controlbox'
      );
      ...
      YAHOO.util.Dom.addClass(
        ...
        'cstudio-form-control-node-selector-items-container'
      );
      ...
      YAHOO.util.Dom.addClass(
        nodeOptionsEl,
        'cstudio-form-control-node-selector-options'
      );
      ...
      YAHOO.util.Dom.addClass(
        countEl,
        'cstudio-form-control-node-selector-count'
      );
            ...
            function(evt) {
              ...
              if (selectItemsCount == 0) {
                ...
                if (_self.addContainerEl) {
                  ...
                  const $addContainerEl = $(
                    '<div class="cstudio-form-control-node-selector-add-container"></div>'
                  );
        ...
        if (this.allowEdit) {
          YAHOO.util.Event.on(
            ...
            function(evt) {
              ...
              selectedDatasource.edit(
                _self.items[_self.selectedItemIndex].key,
                _self
              );
            },
            this.editButtonEl
    ...
    _renderItems: function() {
      ...
      for (var i = 0; i < items.length; i++) {
        ...
        YAHOO.util.Dom.addClass(
          itemEl,
          'cstudio-form-control-node-selector-item'
        );
    ...
    showValidationMessage(message) {
      ...
      this.showValidationMessageTimeout = setTimeout(() => {
        ...
        const langBundle = CMgs.getBundle(
          'forms',
          CStudioAuthoringContext.lang
        );
    ...
    getSupportedProperties: function() {
      return [
        {
          label: CMgs.format(langBundle, 'minSize'),
          name: 'minSize',
          type: 'int'
        },
        {
          label: CMgs.format(langBundle, 'maxSize'),
          name: 'maxSize',
          type: 'int'
        },
        {
        ...
        {
          label: CMgs.format(langBundle, 'readonly'),
          name: 'readonly',
          type: 'boolean'
        },
        {
    ...
    getSupportedConstraints: function() {
      return [
        {
          label: CMgs.format(langBundle, 'allowDuplicate'),
...
NodeSelectorDragAndDropDecorator = function(id, sGroup, config) {
  NodeSelectorDragAndDropDecorator.superclass.constructor.call(
    this,
    id,
    sGroup,
    config
...
YAHOO.extend(NodeSelectorDragAndDropDecorator, YAHOO.util.DDProxy, {
  ...
  startDrag: function(x, y) {
    ...
    YAHOO.util.Dom.setStyle(
      dragEl,
      'color',
      YAHOO.util.Dom.getStyle(clickEl, 'color')
    );
    YAHOO.util.Dom.setStyle(
      dragEl,
      'backgroundColor',
...
CStudioAuthoring.Module.moduleLoaded(
  'cstudio-forms-controls-node-selector',
  CStudioForms.Controls.NodeSelector
);
