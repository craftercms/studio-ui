                  ...
                  success: function (response) {
                    ...
                    var initEditorFn = function () {
                      if (typeof CodeMirror === 'undefined') {
                        ...
                        var codeEditorEl = YAHOO.util.Dom.getElementsByClassName(
                          'CodeMirror',
                          null,
                          editorContainerEl
                        )[0];
                        ...
                        var codeEditorCanvasEl = YAHOO.util.Dom.getElementsByClassName(
                          'CodeMirror-wrap',
                          null,
                          editorContainerEl
                        )[0];
                    ...
                    if (templatePath.indexOf('.ftl') != -1 || templatePath.indexOf('.groovy')) {
                      ...
                      if (variableOpts.length > 0) {
                        ...
                        addButton.onclick = function () {
                          editorEl.codeMirrorEditor.replaceRange(
                            selectList.options[selectList.selectedIndex].value,
                            editorEl.codeMirrorEditor.getCursor()
                          );
                        };
                      }
                    }
