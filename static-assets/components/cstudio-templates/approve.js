...
(function () {
  CStudioAuthoring.register('TemplateHolder.Approve', {
    ITEM_ROW: [
      ...
      /**/ '<td class="name large">',
      /****/ '<div class="in">',
      /******/ '<span id="{index}" class="toggleDependencies ttOpen parent-div-widget" style="margin-right:17px; margin-bottom: -2px; float: left;" data-loaded="false" data-path="{uri}"></span>',
