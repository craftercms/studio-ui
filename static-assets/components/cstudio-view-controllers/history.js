          ...
          success: function (history) {
            ...
            if (versions.length == 0) {
              ...
              for (var i = 0; i < versions.length; i++) {
                ...
                revertActionEl.innerHTML =
                  '<span id="actionRevert' + version.versionNumber + '" class="action fa fa-reply"></span>';
                ...
                (function (item) {
                  Event.addListener(revertActionEl, 'click', function () {
                    CStudioAuthoring.Service.revertContentItem(CStudioAuthoringContext.site, this.item, this.version, {
                      success: function () {
