  ...
  YAHOO.extend(BaseDelete, CStudioAuthoring.ViewController.Base, {
    ...
    loadDependencies: function (selection) {
      ...
      loadFn = function () {
        ...
        CStudioAuthoring.Service.lookupContentDependencies(CStudioAuthoringContext.site, selection, {
    ...
    checkSelectedItems: function (selection) {
      eachfn(
        ...
        function (i, item) {
          ...
          el.checked = true;
          eachfn(
            this.getComponents('input[parentid="' + uri + '"]'),
            function (i, e) {
              if (!e.disabled) {
                e.checked = true;
              }
    ...
    createCalendar: function () {
      ...
      var fn = function (e) {
        ...
        if (el != overlayEl && !Dom.isAncestor(overlayEl, el) && el != input) overlay.hide();
      };
