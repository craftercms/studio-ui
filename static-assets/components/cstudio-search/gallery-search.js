/**
 * CStudio Gallery Search 
 * 
 * TODO: DO NOT EXTEND ALL SEARCH FUNCTIONS
 * MAKE SEARCH A MODULE AND EXTEND ONLY FUNCTIONS THAT CHANGED
 * 
 * @namespace CStudio
 */
...
CStudioSearch.init = function(){
    ...
    var searchCallback = function() {
		...
		// gallery-update: Added openGallerySearch function
 		CStudioAuthoring.Operations.openGallerySearch(
    ...
    // gallery-update
    YAHOO.util.Event.addListener("cstudio-wcm-search-type-dropdown", "change", searchCallback);
    YAHOO.util.Event.addListener("cstudio-wcm-search-uploadtime-dropdown", "change", searchCallback);
...
CStudioSearch.updateSearchContextWithBaseOptions = function() {
	...
	// gallery-update
	CStudioSearch.searchContext.type = encodeURIComponent(document.getElementById('cstudio-wcm-search-type-dropdown').value);
	CStudioSearch.searchContext.time = encodeURIComponent(document.getElementById('cstudio-wcm-search-time-dropdown').value);
...
CStudioSearch.renderCommonResultWrapper = function(contentTO, resultBody) {
	...
	return "<div class='cstudio-search-result' style='float:left;width: 325px; min-height: 200px;padding: 5px'>" +
				"<div id='result-select-" + contentTO.resultId + "' class='cstudio-search-select-container'></div>" +
				"<div id='result-status" + contentTO.resultId + "' style='float: left; margin-left: 32px; display: none;'></div>" +
				...
				if(resultTableEl) {
					...
					if (noPreviewLinks && noPreviewLinks.length >= 1) {
						for (var linkIdx = 0; linkIdx < noPreviewLinks.length; linkIdx++) {
							...
							noPreviewLinks[linkIdx].setAttribute("style", "margin-left: 20px;");
						}
					}
 ...
 * through parameter
 * */
CStudioSearch.viewItemDetails = function(internalName, title, uri) {
	try {
		var width = 0;
		var height = 0;
		...
		var ddetailsHeaderDiv = document.createElement("div");
		ddetailsHeaderDiv.innerHTML = "View Details";
		ddetailsHeaderDiv.style.textAlign = "center";
		ddetailsHeaderDiv.style.clear = "both";
		ddetailsHeaderDiv.style.fontSize = "18px";
		ddetailsHeaderDiv.style.marginTop = "10px";

		var divWrapper = document.createElement("div");
		divWrapper.style.minHeight = "325px";

		var itemWrapper1 = document.createElement("div");
		var itemLabel1 = document.createElement("div");
		var itemValue1 = document.createElement("div");

		itemWrapper1.style.cssFloat = "left";
		itemWrapper1.style.padding = "10px 15px 0px";
		itemWrapper1.style.width = "500px";

		itemLabel1.style.cssFloat = "left";
		itemLabel1.style.width = "150px";
		
		itemValue1.style.cssFloat = "left";
		itemValue1.style.margin = "2px 0px 0px";
		itemValue1.style.width = "350px";
	
		itemLabel1.innerHTML = "Name";
		itemValue1.innerHTML = internalName;
		itemWrapper1.appendChild(itemLabel1);
		itemWrapper1.appendChild(itemValue1);

		var itemWrapper2 = document.createElement("div");
		var itemLabel2 = document.createElement("div");
		var itemValue2 = document.createElement("div");

		itemWrapper2.style.cssFloat = "left";
		itemWrapper2.style.padding = "10px 15px 0px";
		itemWrapper2.style.width = "500px";
		
		itemLabel2.style.cssFloat = "left";
		itemLabel2.style.width = "150px";
		
		itemValue2.style.cssFloat = "left";
		itemValue2.style.margin = "2px 0px 0px";
		itemValue2.style.width = "350px";

		itemLabel2.innerHTML = "Title";
		itemValue2.innerHTML = title;
		itemWrapper2.appendChild(itemLabel2);
		itemWrapper2.appendChild(itemValue2);

		var itemWrapper3 = document.createElement("div");
		var itemLabel3 = document.createElement("div");
		var itemValue3 = document.createElement("div");

		itemWrapper3.style.cssFloat = "left";
		itemWrapper3.style.padding = "10px 15px 0px";
		itemWrapper3.style.width = "500px";
		
		itemLabel3.style.cssFloat = "left";
		itemLabel3.style.width = "150px";
		
		itemValue3.style.cssFloat = "left";
		itemValue3.style.margin = "2px 0px 0px";
		itemValue3.style.width = "350px";

		itemLabel3.innerHTML = "URL";
		itemValue3.innerHTML = uri;
		itemWrapper3.appendChild(itemLabel3);
		itemWrapper3.appendChild(itemValue3);

		divWrapper.appendChild(itemWrapper1);
		divWrapper.appendChild(itemWrapper2);
		divWrapper.appendChild(itemWrapper3);
		...
		buttonHolderDiv.style.clear = "both";
		...
		containerDiv.appendChild(ddetailsHeaderDiv);
		containerDiv.appendChild(divWrapper);
