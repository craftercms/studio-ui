 ...
 */
CStudioAuthoringWidgets.ApprovedScheduledItemsDashboard =
  CStudioAuthoringWidgets.ApprovedScheduledItemsDashboard ||
    ...
    this.renderItemsHeading = function () {
      ...
      var header =
        ...
        WcmDashboardWidgetCommon.getSimpleRow(
          'server',
          widgetId,
          CMgs.format(langBundle, 'dashletApprovedSchedColEnvironment'),
          'maximize'
        ) +
        WcmDashboardWidgetCommon.getSimpleRow(
          'packageId',
    ...
    this.renderAuxControls = function (containerEl) {
      ...
      filterByEl.onchange = function () {
        ...
        filterByEl.options[3] = new Option(
          CMgs.format(langBundle, 'dashletApprovedSchedFilterAll'),
          'all',
          true,
          false
        );
