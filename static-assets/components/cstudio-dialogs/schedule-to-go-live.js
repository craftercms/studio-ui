 ...
 * GoLive Constructor
 */
CStudioAuthoring.Dialogs.DialogScheduleToGoLive =
  CStudioAuthoring.Dialogs.DialogScheduleToGoLive ||
  function () {
...
CStudioAuthoring.Module.requireModule(
  ...
  {},
  {
    moduleLoaded: function (moduleName, parentClass) {
      ...
      CStudioAuthoring.Dialogs.DialogScheduleToGoLive.prototype.handleDependencies = function (
        matchedInputElement,
        isChecked
      ) {
      ...
      CStudioAuthoring.Dialogs.DialogScheduleToGoLive.prototype.displayItemListWithDependencies = function (
        dependencyList
      ) {
      ...
      CStudioAuthoring.Dialogs.DialogScheduleToGoLive.prototype.getDependenciesForGoLiveItemList = function (
        contentItems
      ) {
        var self = this;
