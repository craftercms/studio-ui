...
CStudioAuthoring.Dialogs.DialogCreateTaxonomy = CStudioAuthoring.Dialogs.DialogCreateTaxonomy || {
  ...
  createDialog: function(taxonomyType, taxonomyName, path, selectTemplateCb) {
    ...
    newdiv.innerHTML =
      '<div class="contentTypePopupInner" id="ct_contentTypePopupInner" style="width:600px;height:240px;">' +
      ...
      '<input id="taxonomyTypeVal" type="hidden" value="' +
      taxonomyType +
      '" />' +
      '<input id="taxonomyPathVal" type="hidden" value="' +
      path +
      '" />' +
      '<table>' +
