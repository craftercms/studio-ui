    ...
    renderText: function () {
      ...
      var editor = tinyMCE.init({
        ...
        theme_advanced_buttons1:
          'bold,italic,underline,|,forecolor,backcolor,|,bullist,numlist,|,link,unlink,anchor,|,undo,redo',
        theme_advanced_buttons2:
          'formatselect,fontselect,fontsizeselect,|,justifyleft,justifycenter,justifyright,justifyfull',
