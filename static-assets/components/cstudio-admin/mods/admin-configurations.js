  ...
  {},
  {
    moduleLoaded: function () {
      CStudioAuthoring.Utils.addJavascript(
        '/static-assets/components/cstudio-common/codemirror/lib/util/formatting.js'
      );
      CStudioAuthoring.Utils.addJavascript('/static-assets/components/cstudio-common/codemirror/mode/xml/xml.js');
      CStudioAuthoring.Utils.addJavascript(
        '/static-assets/components/cstudio-common/codemirror/mode/javascript/javascript.js'
      );
      CStudioAuthoring.Utils.addJavascript(
        '/static-assets/components/cstudio-common/codemirror/mode/htmlmixed/htmlmixed.js'
      );
      ...
      YAHOO.extend(CStudioAdminConsole.Tool.AdminConfig, CStudioAdminConsole.Tool, {
        ...
        setEditor: function (editorContainerEl, editorEl, readOnly) {
          ...
          var codeEditorScrollEl = YAHOO.util.Dom.getElementsByClassName(
            'CodeMirror-scroll',
            null,
            editorContainerEl
          )[0];
        ...
        addButtons: function (containerEl, itemSelectEl, editor) {
          containerEl.innerHTML =
            "<button type='submit' id='view-sample-button' class='btn btn-primary'>" +
            CMgs.format(formsLangBundle, 'viewSample') +
            '</button>' +
            "<button type='submit' id='hide-sample-button' class='btn btn-primary'>" +
            CMgs.format(formsLangBundle, 'hideSample') +
            '</button>';
