...
CStudioAuthoring.ContextualNav.WcmAssetsFolder = CStudioAuthoring.ContextualNav.WcmAssetsFolder || {
  ...
  drawTreeItem: function (treeNodeTO, root, instance) {
    ...
    if (treeNodeTO.container == true || treeNodeTO.name != 'index.xml') {
      ...
      if (!Self.treeNodes) Self.treeNodes = [];
  ...
  save: function (instance, path, fileName, num, mode) {
    ...
    CStudioAuthoring.ContextualNav.WcmAssetsFolder.storage.write(
      Self.getStoredPathKey(instance),
    ...
    var menuItems = {
      ...
      assetsFolderMenu: [
        ...
        },
        {
          ...
          onclick: { fn: CStudioAuthoring.ContextualNav.WcmAssetsFolder.createContainer, obj: tree }
        },
        {
          text: CMgs.format(siteDropdownLangBundle, 'renameFolder'),
          onclick: { fn: CStudioAuthoring.ContextualNav.WcmAssetsFolder.renameContainer, obj: tree }
        },
        {
          text: CMgs.format(siteDropdownLangBundle, 'delete'),
          onclick: { fn: CStudioAuthoring.ContextualNav.WcmAssetsFolder.deleteContainer, obj: tree }
        }
      ],
      ...
      assetsMenuNoDelete: [
        {
          text: CMgs.format(siteDropdownLangBundle, 'upload'),
          onclick: { fn: CStudioAuthoring.ContextualNav.WcmAssetsFolder.overwriteAsset, obj: tree }
        }
      ],
      ...
      assetsFolderTemplate: [
        {
          ...
          disabled: false,
          onclick: { fn: CStudioAuthoring.ContextualNav.WcmAssetsFolder.createNewTemplate, obj: tree }
        }
      ],
      ...
      assetsFolderScript: [
        {
          ...
          disabled: false,
          onclick: { fn: CStudioAuthoring.ContextualNav.WcmAssetsFolder.createNewScript, obj: tree }
        }
      ],
      ...
      assetsMenuView: [
        {
          ...
          disabled: false,
          onclick: { fn: CStudioAuthoring.ContextualNav.WcmAssetsFolder.editTemplate, obj: 'read' }
        }
      ]
    };
                  ...
                  fn: function () {
                    var callback = {
                      success: function (contentTO) {
                        ...
                        CStudioAuthoring.Operations.approveCommon(CStudioAuthoringContext.site, selectedContent, false);
                      },
                      failure: function () {}
                    };
              ...
              fn: function () {
                var callback = {
                  success: function (contentTO) {
                    ...
                    CStudioAuthoring.Operations.viewDependencies(CStudioAuthoringContext.site, selectedContent, false);
                  },
                  failure: function () {}
                };
  ...
  createContainer: function () {
    ...
    CStudioAuthoring.Operations.createFolder(CStudioAuthoringContext.site, oCurrentTextNode.data.uri, window, createCb);
  },
  ...
  renameContainer: function () {
    ...
    CStudioAuthoring.Operations.renameFolder(CStudioAuthoringContext.site, oCurrentTextNode.data.uri, window, createCb);
  },
  ...
  bulkUpload: function () {
    ...
    CSA.Env.Loader.use('component-dropbox', 'dialog-bulkupload', function () {
      ...
      var dropbox = new Dropbox({
        ...
        display: fmt('#{0} .file-display-container .pad', view.id),
