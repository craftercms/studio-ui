...
CStudioAuthoring.ContextualNav.WcmTaxonomiesFolder = CStudioAuthoring.ContextualNav.WcmTaxonomiesFolder || {
  ...
  drawTaxonomyRoot: function (tree, instance) {
    ...
    var contextMenu = new YAHOO.widget.ContextMenu('ContextmenuWrapper', {
  ...
  onLoadNodeDataOnClick: function (node, fnLoadComplete) {
    ...
    CStudioAuthoring.Service.getTaxonomy(
      site,
      node.treeNodeTO.taxonomyName,
      node.treeNodeTO.level,
      false,
      'item',
      dataCb
    );
  ...
  orderTaxonomy: function () {
    ...
    CStudioAuthoring.Operations.orderTaxonomy(
      CStudioAuthoringContext.site,
      curNode.taxonomyName,
      curNode.level,
      orderedCb
    );
  },
