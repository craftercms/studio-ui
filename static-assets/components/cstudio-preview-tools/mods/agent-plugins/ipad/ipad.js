  ...
  render: function (containerEl, config) {
    ...
    if (mode == 'vert') {
      ...
      emulateEl.style.background =
        ...
        "/static-assets/components/cstudio-preview-tools/mods/agent-plugins/ipad/ipad.gif')";
      ...
      rotateControlEl.style.background =
        "url('" +
        CStudioAuthoringContext.authoringAppBaseUri +
        "/static-assets/components/cstudio-preview-tools/mods/agent-plugins/ipad/object-rotate-right.png')";
