(function () {
  ...
  function scriptHint(editor, keywords, getToken) {
    ...
    return { list: completionList, from: { line: cur.line, ch: token.start }, to: { line: cur.line, ch: token.end } };
  }
  ...
  function getCompletions(token, context) {
    ...
    if (context) {
      ...
      if (obj.className == 'pig-word') base = obj.string;
      else if (obj.className == 'pig-type') base = ':' + obj.string;
