...
(function () {
  ...
  const PLUGIN_PASTE_TEXT_LABEL = 'paste_as_text';
  ...
  tinymce.PluginManager.add(PLUGIN_LABEL, function (editor, url) {
    ...
    editor.ui.registry.addToggleButton(PLUGIN_PASTE_TEXT_LABEL, {
      active: false,
    ...
    editor.ui.registry.addToggleMenuItem(PLUGIN_PASTE_TEXT_LABEL, {
