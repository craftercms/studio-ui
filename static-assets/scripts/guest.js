...
define('guest', [
  ...
  'pointer-controller',
  'cache'
], function (crafter, $, Communicator, ICEOverlay, DnDController, PointerController, Cache) {
  'use strict';
  ...
  function init(config) {
    ...
    var pathFontAwesome = crafter.join(
    ...
    if (!$("link[href*='font-awesome']").length) loadCss(config.hostOrigin + '/' + pathFontAwesome);
