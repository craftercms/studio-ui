...
(function (angular, $) {
  ...
  app.service('adminService', [
    ...
    function ($http, Constants, $cookies, $timeout, $window) {
      ...
      this.bulkGoLive = function (site, path, environmet) {
        ...
        return $http.post(
          bulkPublish('bulk-golive', 'site_id=' + site + '&path=' + path + '&environment=' + environmet)
        );
      };
  ...
  app.controller('PublishingCtrl', [
    ...
    function (
      ...
      publish.continue = function () {
        ...
        adminService
          .bulkGoLive(publish.site, publish.pathPublish, publish.selectedChannel)
          .success(function (data) {
  ...
  app.controller('UsersCtrl', [
    ...
    '$translate',
    '$location',
    function ($scope, $state, $window, $sce, adminService, $modal, $timeout, $stateParams, $translate, $location) {
      $scope.users = {};
  ...
  app.controller('GroupsCtrl', [
    ...
    '$location',
    '$q',
    function ($scope, $state, $window, $sce, adminService, $modal, $timeout, $stateParams, $translate, $location, $q) {
      $scope.groups = {};
        ...
        var removeUserFromGroup = function () {
          adminService
            ...
            .success(function () {
              $scope.getUsersFromGroup(group);
              $scope.notification(
                user.username + ' successfully removed from ' + group.group_name,
                false,
                null,
                'studioMedium'
              );
