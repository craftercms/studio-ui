...
(function() {
	var TreeWalker = tinymce2.dom.TreeWalker;
		...
		function handleKey(ed, e) {
			...
			function canDelete(backspace) {
				...
				function isNextPrevTreeNodeNonEditable() {
					...
					walker = new tinymce2.dom.TreeWalker(container, ed.getBody());
			...
			if (nonEditableParent && (keyCode < 112 || keyCode > 124) && keyCode != VK.DELETE && keyCode != VK.BACKSPACE) {
				...
				if ((tinymce2.isMac ? e.metaKey : e.ctrlKey) && (keyCode == 67 || keyCode == 88 || keyCode == 86)) {
					return;
				}
	...
	tinymce2.create('tinymce2.plugins.NonEditablePlugin', {
		init : function(ed, url) {
			var editClass, nonEditClass, nonEditableRegExps;

			// Converts configured regexps to noneditable span items
			function convertRegExpsToNonEditable(ed, args) {
				var i = nonEditableRegExps.length, content = args.content, cls = tinymce2.trim(nonEditClass);
			...
			editClass = " " + tinymce2.trim(ed.getParam("noneditable_editable_class", "mceEditable")) + " ";
			nonEditClass = " " + tinymce2.trim(ed.getParam("noneditable_noneditable_class", "mceNonEditable")) + " ";
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/noneditable',
	...
	// Register plugin
	tinymce2.PluginManager.add('noneditable', tinymce2.plugins.NonEditablePlugin);
})();