...
(function() {
	tinymce2.create('tinymce2.plugins.AutolinkPlugin', {
	/**
	...
	*/
	...
	init : function(ed, url) {
		...
		parseCurrentLine : function(ed, end_offset, delimiter, goback) {
			...
			if (matches) {
				...
				tinymce2.execCommand('createlink',false, matches[1] + matches[2]);
		...
		*/
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/autolink',
	...
	// Register plugin
	tinymce2.PluginManager.add('autolink', tinymce2.plugins.AutolinkPlugin);
})();
