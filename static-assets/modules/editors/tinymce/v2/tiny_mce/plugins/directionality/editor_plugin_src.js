...
(function() {
	tinymce2.create('tinymce2.plugins.Directionality', {
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/directionality',
	...
	// Register plugin
	tinymce2.PluginManager.add('directionality', tinymce2.plugins.Directionality);
})();