...
(function() {
	...
	tinymce2.create('tinymce2.plugins.Layer', {
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/layer',
		...
		_visualAid : function(ed, e, s) {
			...
			tinymce2.each(dom.select('div,p', e), function(e) {
		...
		_move : function(d) {
			...
			nl = [];
			tinymce2.walk(ed.getBody(), function(n) {
	...
	// Register plugin
	tinymce2.PluginManager.add('layer', tinymce2.plugins.Layer);
})();