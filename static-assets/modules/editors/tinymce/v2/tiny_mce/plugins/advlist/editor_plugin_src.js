...
(function() {
	...
	tinymce2.create('tinymce2.plugins.AdvListPlugin', {
		init : function(ed, url) {
			...
			if (tinymce2.isIE && /MSIE [2-7]/.test(navigator.userAgent))
				t.isIE7 = true;
		},
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/advlist',
	...
	// Register plugin
	tinymce2.PluginManager.add('advlist', tinymce2.plugins.AdvListPlugin);
})();