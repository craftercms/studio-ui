...
(function() {
	tinymce2.create('tinymce2.plugins.VisualChars', {
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/visualchars',
	...
	// Register plugin
	tinymce2.PluginManager.add('visualchars', tinymce2.plugins.VisualChars);
})();