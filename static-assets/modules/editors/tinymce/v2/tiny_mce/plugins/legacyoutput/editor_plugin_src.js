 ...
 *
 * This plugin will force tinymce2 to produce deprecated legacy output such as font elements, u elements, align
...
(function(tinymce2) {
	// Override inline_styles setting to force tinymce2 to produce deprecated contents
	tinymce2.onAddEditor.addToTop(function(tinymce2, editor) {
		editor.settings.inline_styles = false;
	});

	// Create the legacy ouput plugin
	tinymce2.create('tinymce2.plugins.LegacyOutput', {
		init : function(editor) {
			editor.onInit.add(function() {
				var alignElements = 'p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li,table,img',
					fontSizes = tinymce2.explode(editor.settings.font_size_style_values),
				...
				editor.formatter.register({
					...
					fontsize : {
						...
						attributes : {
							size : function(vars) {
								return tinymce2.inArray(fontSizes, vars.value) + 1;
							}
						}
					},
				...
				tinymce2.each('b,i,u,strike'.split(','), function(name) {
				...
				tinymce2.each(alignElements.split(','), function(name) {
				...
				editor.onNodeChange.add(function(editor, control_manager) {
					...
					if (control = control_manager.get('fontsizeselect')) {
						control.select(function(value) {
							var index = tinymce2.inArray(fontSizes, value.fontSize);
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/legacyoutput',
	...
	// Register plugin
	tinymce2.PluginManager.add('legacyoutput', tinymce2.plugins.LegacyOutput);
})(tinymce2);
