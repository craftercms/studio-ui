...
(function() {
	tinymce2.create('tinymce2.plugins.VisualBlocks', {
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/visualblocks',
	...
	// Register plugin
	tinymce2.PluginManager.add('visualblocks', tinymce2.plugins.VisualBlocks);
})();