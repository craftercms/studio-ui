...
(function() {
	...
	tinymce2.create('tinymce2.plugins.TemplatePlugin', {
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/template',
	...
	// Register plugin
	tinymce2.PluginManager.add('template', tinymce2.plugins.TemplatePlugin);
})();