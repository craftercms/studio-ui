...
(function() {
	 ...
	 */
	tinymce2.create('tinymce2.plugins.ContextMenu', {
		/**
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/contextmenu',
	...
	// Register plugin
	tinymce2.PluginManager.add('contextmenu', tinymce2.plugins.ContextMenu);
})();
