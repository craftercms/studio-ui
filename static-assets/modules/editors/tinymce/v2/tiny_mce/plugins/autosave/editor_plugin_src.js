 ...
 *
 * Adds auto-save capability to the tinymce2 text editor to rescue content
 ...
 * supported by tinymce2.  The content is persistent across browser restarts and expires on the
 * date/time specified, just like a cookie.  However, the data is not cleared when the user clears
 * cookies on the browser, which makes it well-suited for rescuing autosaved content.  UserData,
 * like other Microsoft IE browser technologies, is implemented as a behavior attached to a
 * specific DOM object, so in this case we attach the behavior to the same DOM element that the
 * tinymce2 editor instance is attached to.
 */
...
(function(tinymce2) {
	...
	var PLUGIN_NAME = 'autosave',
		...
		undefined,
		unloadHandlerAdded,
		Dispatcher = tinymce2.util.Dispatcher;

	/**
	 * This plugin adds auto-save capability to the tinymce2 text editor to rescue content
	 * inadvertently lost. By using localStorage.
	 *
	 * @class tinymce2.plugins.AutoSave
	 */
	tinymce2.create('tinymce2.plugins.AutoSave', {
		/**
		...
		init : function(ed, url) {
			 ...
			 *
			 * @event onStoreDraft
			 * @param {tinymce2.plugins.AutoSave} sender Plugin instance sending the event.
			...
			if (!unloadHandlerAdded) {
				window.onbeforeunload = tinymce2.plugins.AutoSave._beforeUnloadHandler;
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/autosave',
		...
		"static" : {
			...
			_beforeUnloadHandler : function(e) {
				...
				tinymce2.each(tinymce2.editors, function(ed) {
	...
	tinymce2.PluginManager.add('autosave', tinymce2.plugins.AutoSave);
})(tinymce2);
