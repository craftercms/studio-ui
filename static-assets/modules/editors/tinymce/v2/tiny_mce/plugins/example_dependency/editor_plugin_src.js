...
(function() {
	...
	tinymce2.create('tinymce2.plugins.ExampleDependencyPlugin', {
		/**
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/example_dependency',
				version : "1.0"
			};
		}
	});
	 ...
	 */
	tinymce2.PluginManager.add('example_dependency', tinymce2.plugins.ExampleDependencyPlugin, ['example']);
})();
