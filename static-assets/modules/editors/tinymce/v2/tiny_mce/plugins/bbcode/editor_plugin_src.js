...
(function() {
	tinymce2.create('tinymce2.plugins.BBCodePlugin', {
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/bbcode',
	...
	// Register plugin
	tinymce2.PluginManager.add('bbcode', tinymce2.plugins.BBCodePlugin);
})();