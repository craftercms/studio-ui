...
(function(tinymce2) {
		...
		function cloneCell(cell) {
			...
			tinymce2.walk(cell, function(node) {
				...
				if (node.nodeType == 3) {
					...
					if (curNode)
						curNode.innerHTML = tinymce2.isIE && !tinymce2.isIE11 ? '&nbsp;' : '<br data-mce-bogus="1" />';
	...
	tinymce2.create('tinymce2.plugins.TablePlugin', {
		init : function(ed, url) {
			...
			ed.onInit.add(function(ed) {
					...
					function moveSelection(ed, e) {
						...
						function handle(upBool, sourceNode, event) {
							...
							if (siblingRow) {
								...
								tinymce2.dom.Event.cancel(event);
								return true;
							} else {
						...
						function escapeTable(upBool, currentRow, siblingDirection, table, event) {
							...
							if (tableSibling) {
								...
								if (parentCell) {
									...
									return tinymce2.dom.Event.cancel(event);
								}
							}
						}
				...
				function fixTableCaretPos() {
					...
					if (last && last.nodeName == 'TABLE') {
						if (ed.settings.forced_root_block)
							ed.dom.add(ed.getBody(), ed.settings.forced_root_block, null, tinymce2.isIE && !tinymce2.isIE11 ? '&nbsp;' : '<br data-mce-bogus="1" />');
						else
				...
				if (tinymce2.isGecko) {
					ed.onKeyDown.add(function(ed, e) {
						if (e.keyCode === tinymce2.VK.ENTER && e.shiftKey) {
	...
	// Register plugin
	tinymce2.PluginManager.add('table', tinymce2.plugins.TablePlugin);
})(tinymce2);
