...
(function() {
	tinymce2.create('tinymce2.plugins.InsertDateTime', {
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/insertdatetime',
	...
	// Register plugin
	tinymce2.PluginManager.add('insertdatetime', tinymce2.plugins.InsertDateTime);
})();