...
(function() {
	tinymce2.create('tinymce2.plugins.XHTMLXtrasPlugin', {
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/xhtmlxtras',
	...
	// Register plugin
	tinymce2.PluginManager.add('xhtmlxtras', tinymce2.plugins.XHTMLXtrasPlugin);
})();