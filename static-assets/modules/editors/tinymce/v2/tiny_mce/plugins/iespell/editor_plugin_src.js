...
(function() {
	tinymce2.create('tinymce2.plugins.IESpell', {
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/tinymce2:Plugins/iespell',
	...
	// Register plugin
	tinymce2.PluginManager.add('iespell', tinymce2.plugins.IESpell);
})();