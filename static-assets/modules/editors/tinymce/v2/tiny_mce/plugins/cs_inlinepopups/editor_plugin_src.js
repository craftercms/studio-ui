...
(function() {
	...
	tinymce2.create('tinymce2.plugins.CStudioInlinePopups', {
...
//			cp = DOM.getPos(t.editor.getContainer());
	...
	// Register plugin
	tinymce2.PluginManager.add('cs_inlinepopups', tinymce2.plugins.CStudioInlinePopups);
})();
