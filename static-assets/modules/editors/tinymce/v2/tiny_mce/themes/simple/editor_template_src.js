...
(function() {
	...
	tinymce2.ThemeManager.requireLangPack('simple');

	tinymce2.create('tinymce2.themes.SimpleTheme', {
		init : function(ed, url) {
			...
			ed.onInit.add(function() {
				ed.onNodeChange.add(function(ed, cm) {
					tinymce2.each(states, function(c) {
	...
	tinymce2.ThemeManager.add('simple', tinymce2.themes.SimpleTheme);
})();